...
public class NewsAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.item_img_icon = (MyImageView) convertView.findViewById(R.id.news_img);;
            viewHolder.item_tv_des = (TextView) convertView.findViewById(R.id.news_des);
            viewHolder.item_tv_title = (TextView) convertView.findViewById(R.id.news_title);
            viewHolder.item_tv_comment = (TextView) convertView.findViewById(R.id.news_comment);
            viewHolder.item_tv_type = (TextView) convertView.findViewById(R.id.news_type);
        ...
        switch (newsBean.getType()) {
            ...
            case 1:
                ...
                break;
            case 2:
                viewHolder.item_tv_type.setText("IT");
                break;
            default:
                break;
        }
